...
#include "ui_QtVtkDialog.h"

#define VTK_CREATE(type, name) \
  vtkSmartPointer<type> name = vtkSmartPointer<type>::New()

QtVtkDialog::QtVtkDialog(QWidget *parent)
	: QDialog(parent)
{
	ui = new Ui::QtVtkDialog();
	ui->setupUi(this);
	QTextCodec::setCodecForLocale(QTextCodec::codecForName("UTF-8"));
	//setWindowState(Qt::WindowMaximized);
	//setMinimumSize(300,300);
	Qt::WindowFlags flags = Qt::Dialog;
	//flags |= Qt::WindowMinimizeButtonHint | Qt::WindowMaximizeButtonHint | Qt::WindowCloseButtonHint | Qt::CustomizeWindowHint | Qt::FramelessWindowHint;
...
void QtVtkDialog::openvtkpicture(QString filepathname)
{
...
*/
void QtVtkDialog::openstlpicture(QString filepathname)
{
...
void QtVtkDialog::opendcmpicture(QString filepathname)
{
...
void QtVtkDialog::openotherpicture(QString filepathname)
{
	vtkSmartPointer<vtkDICOMImageReader> reader = vtkSmartPointer<vtkDICOMImageReader>::New();
	//reader->SetFileName("E:\\IM12");//Benchmark_tube2.exo
	reader->SetFileName("E:\\benchmark_norm_00percentoff_imp2.vtk");
